...
class appDevDebugProjectContainer extends Container
{
    ...
    {
        $a = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('hSUKGWjz3S', 0, ($this->targetDirs[0].'/pools'));
    ...
    {
        return $this->services['cache.system'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('syjqGBbkRK', 0, 'MmVoRLumffFL4U+IBhhb41', ($this->targetDirs[0].'/pools'), ${($_ = isset($this->services['monolog.logger.cache']) ? $this->services['monolog.logger.cache'] : $this->getMonolog_Logger_CacheService()) && false ?: '_'}));
    }
    ...
    {
        return $this->services['cache.annotations'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('F75uDDVzot', 0, 'MmVoRLumffFL4U+IBhhb41', ($this->targetDirs[0].'/pools'), ${($_ = isset($this->services['monolog.logger.cache']) ? $this->services['monolog.logger.cache'] : $this->getMonolog_Logger_CacheService()) && false ?: '_'}));
    }
    ...
    {
        return $this->services['cache.serializer'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('04N+3hLuEV', 0, 'MmVoRLumffFL4U+IBhhb41', ($this->targetDirs[0].'/pools'), ${($_ = isset($this->services['monolog.logger.cache']) ? $this->services['monolog.logger.cache'] : $this->getMonolog_Logger_CacheService()) && false ?: '_'}));
    }
    ...
    {
        return $this->services['cache.validator'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('JPUL0dJ0V0', 0, 'MmVoRLumffFL4U+IBhhb41', ($this->targetDirs[0].'/pools'), ${($_ = isset($this->services['monolog.logger.cache']) ? $this->services['monolog.logger.cache'] : $this->getMonolog_Logger_CacheService()) && false ?: '_'}));
    }
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath(($this->targetDirs[3].'/vendor/doctrine/doctrine-bundle/Resources/views'), '!Doctrine');
        $instance->addPath(($this->targetDirs[3].'/src/PPE/SOSPLAYERBundle/Resources/views'), 'PPESOSPLAYER');
        $instance->addPath(($this->targetDirs[3].'/src/PPE/SOSPLAYERBundle/Resources/views'), '!PPESOSPLAYER');
        $instance->addPath(($this->targetDirs[3].'/src/PPE/AccueilBundle/Resources/views'), 'PPEAccueil');
        $instance->addPath(($this->targetDirs[3].'/src/PPE/AccueilBundle/Resources/views'), '!PPEAccueil');
    ...
    private function getDynamicParameter($name)
    {
        switch ($name) {
            ...
            case 'kernel.bundles_metadata': $value = array(
                ...
                'PPESOSPLAYERBundle' => array(
                    'parent' => NULL,
                    'path' => ($this->targetDirs[3].'/src/PPE/SOSPLAYERBundle'),
                    'namespace' => 'PPE\\SOSPLAYERBundle',
                ),
                'PPEAccueilBundle' => array(
                    'parent' => NULL,
                    'path' => ($this->targetDirs[3].'/src/PPE/AccueilBundle'),
                    'namespace' => 'PPE\\AccueilBundle',
                ),
                'DebugBundle' => array(
                    'parent' => NULL,
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'kernel.bundles' => array(
                ...
                'PPESOSPLAYERBundle' => 'PPE\\SOSPLAYERBundle\\PPESOSPLAYERBundle',
                'PPEAccueilBundle' => 'PPE\\AccueilBundle\\PPEAccueilBundle',
